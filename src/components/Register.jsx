...
const Register = () =>{
    ...
    <div className='registerPage'>
        ...
        <div className='genInfo'>
            ...
            <input className='regPass' name='password' onChange={handleChange} value={uInfo.password} placeholder="Password"></input>
            <input className='confPass' name='city' onChange={handleChange} value={uInfo.confPass} placeholder="Confirm Password"></input>
        </div>
